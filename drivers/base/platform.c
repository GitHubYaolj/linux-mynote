...
int __init platform_bus_init(void)
{
	...
	error = device_register(&platform_bus);//.init_name	= "platform",在sysfs中创建“/sys/devices/platform/”目录，所有的Platform设备，都会包含在此目录下。
	if (error)
		return error;
	error =  bus_register(&platform_bus_type);//该步骤会在sysfs中创建“/sys/bus/platform/”目录
	if (error)
